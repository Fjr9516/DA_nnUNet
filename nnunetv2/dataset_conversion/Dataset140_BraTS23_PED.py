...
# setup env var, change it to your paths:
nnUNet_raw="/home/jovyan/Datasets/nnUNet_raw"
nnUNet_preprocessed="/home/jovyan/Datasets/nnUNet_preprocessed"
nnUNet_results="/home/jovyan/Datasets/nnUNet_results"
...
def convert_labels_back_to_BraTS(seg: np.ndarray):
    ...
    new_seg[seg == 1] = 2
    new_seg[seg == 3] = 3 # JR: for BraTS new conversion
    new_seg[seg == 2] = 1
    return new_seg
...
if __name__ == '__main__':
    brats_data_dir = '/path/to/your/data/BraTS2023-PED/ASNR-MICCAI-BraTS2023-PED-Challenge-TrainingData'

    task_id = 140
    task_name = "BraTS2023_PED"
